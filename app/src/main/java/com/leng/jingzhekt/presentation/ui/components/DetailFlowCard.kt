    ...
    Card(
        ...
        Box(
            ...
            Column(
                ...
                Text("结余", fontWeight = FontWeight.ExtraBold, fontSize = 10.sp)
                ...
                Row(
                    ...
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text("本月支出", fontWeight = FontWeight.Bold, fontSize = 10.sp)
                        Text("￥0.00", fontWeight = FontWeight.Bold)
                    }
                    VerticalDivider(thickness = 2.dp, modifier = Modifier.height(16.dp))
                    Column {
                        Text("本月收入", fontWeight = FontWeight.Bold, fontSize = 10.sp)
                        Text("￥0.00", fontWeight = FontWeight.Bold)
                    }
                    VerticalDivider(thickness = 2.dp, modifier = Modifier.height(16.dp))
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text("本月预算", fontWeight = FontWeight.Bold, fontSize = 10.sp)
                        Text("￥0.00", fontWeight = FontWeight.Bold)
                    }

                    VerticalDivider(thickness = 2.dp, modifier = Modifier.height(16.dp))
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text("本月剩余", fontWeight = FontWeight.Bold, fontSize = 10.sp)
                        Text("￥0.00", fontWeight = FontWeight.Bold)
                    }
