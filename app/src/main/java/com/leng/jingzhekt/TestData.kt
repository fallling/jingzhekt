...
class TestData {
    ...
    companion object{
        ...
        val bill1 = Bill.create(classify1, BillType.EXPEND, LocalDateTime.now(), 156.0f,"购物测试1")
        val bill2 = Bill.create(classify2, BillType.EXPEND, LocalDateTime.now(), 15.0f,"购物测试1")
        val bill3 = Bill.create(classify3, BillType.EXPEND, LocalDateTime.now(), 560.02f,"购物测试1")

        val dailyBill1 = DailyBill.create(listOf(bill1,bill2,bill3))
